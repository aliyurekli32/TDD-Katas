...
describe("AgeCalculator", () => {
  ...
  test("should throw an error if birth date is after current date", () => {
    const ageCalculator = new AgeCalculator();
  ...
  test("should return September 3, 2017; If I was born on September 9, 2017", () => {
    const ageCalculator = new AgeCalculator();
  ...
  test("should return August 28, 2017; If I was born on September 3, 2017", () => {
    const ageCalculator = new AgeCalculator();
    const startDateOfBirthdayWeek =
